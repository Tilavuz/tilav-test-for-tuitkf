    ...
    <form onSubmit={handleSubmit} className="flex pt-20 md:pt-0 flex-col justify-center items-center h-screen px-4 gap-4">
      ...
      <div className="flex flex-col">
        <div className="flex gap-2">
          <input maxLength={6} name="loginCode" onChange={handleInput} className="border-2 py-2 px-4 rounded-md outline-slate-950" type="password" placeholder="Enter code" required autoComplete="off"/>
